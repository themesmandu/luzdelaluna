		...
		<h2 class="comments-title">
			...
			if ( '1' === $luzdelaluna_comment_count ) {
				...
				printf( // WPCS: XSS OK.
					...
					esc_html( _nx( '%1$s thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', $luzdelaluna_comment_count, 'comments title', 'luzdelaluna' ) ),
					number_format_i18n( $luzdelaluna_comment_count ),
					'<span>' . get_the_title() . '</span>'
				);
			}
			?>
