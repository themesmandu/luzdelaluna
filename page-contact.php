    ...
    <div id="contact" class="contact">
        <div class="row">
            <div class="col-lg-4 col-md-5">
                ...
                <img src="<?php echo esc_url( wp_get_attachment_url( get_theme_mod( 'contact_image') ) ); ?>" class="contact-image" />
                ...
                <address>
                    <ul class="address">
                        ...
                        <li>
                            <span
                                class="uppercase bold-7"><?php echo esc_html__( 'Office Hours', 'luzdelaluna' ); ?></span>
